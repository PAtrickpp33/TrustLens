...
# ======== Routes ========
@router.get("/healthz", response_model=ApiResponse, summary="Return the LLM Service's current state")
...
@router.post("/score", response_model=ApiResponse, summary="Calculate the risk score of a URL")
...
@router.post("/recommend", response_model=ApiResponse, summary="Generate an AI rationale and recommendation on the URL risk score")
...
@router.post("/__reload", response_model=ApiResponse, summary="Reload the current LLM risk service's URL scoring model")

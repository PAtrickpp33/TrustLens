...
CREATE TABLE `risk_mobile` (
  ...
  `risk_level` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-unknown, 1-safe, 2-low risk, 3-medium risk, 4-unsafe',
  ...
  `notes` TEXT NULL DEFAULT NULL COMMENT 'AI-generated evaluation notes',
